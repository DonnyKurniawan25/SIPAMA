...
<div class="card bg-light-info shadow-none position-relative overflow-hidden">
    <div class="card-body px-4 py-3">
        <div class="row align-items-center">
            <div class="col-9">
                <h4 class="fw-semibold mb-8">Gejala</h4>
...
<div class="card w-100 position-relative overflow-hidden">
    <div class="px-4 py-3 border-bottom">
        <h5 class="card-title fw-semibold mb-0 lh-sm">Data Gejala</h5>
    </div>
                                ...
                                <div class="dropdown dropstart">
                                  ...
                                  <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                    <form onsubmit="event.preventDefault()" id="myForm-{{ $p->id }}" method="post"
                                        action="{{ route('gejala.destroy', $p->id) }}">
                                        @csrf
                                        @method('DELETE')
                                        <li>
                                            <a class="dropdown-item d-flex align-items-center gap-3" href="{{ route('gejala.edit', $p->id) }}"><i class="fs-4 ti ti-edit"></i>Edit</a>
                                        </li>
                                        <li>
...
<script type="text/javascript">
    function Hapus(id) {
        Swal.fire({
            title: 'Anda Yakin Menghapus Data ID '+id+"??",
